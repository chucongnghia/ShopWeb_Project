...
public partial class ShopWebDbContext : DbContext
{
    public ShopWebDbContext()
    {
    }

    public ShopWebDbContext(DbContextOptions<ShopWebDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=LAPTOP-CUA-CCNG\\SQLEXPRESS;Initial Catalog=ShopWebDB;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
        }
    }
